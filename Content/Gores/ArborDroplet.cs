...
namespace Arbour.Content.Gores;

public class ArborDroplet : ModGore
{
	...
	{
		gore.alpha = gore.position.Y < Main.worldSurface * 16 + 8 ? 0 : 100;
		...
		else if (gore.frame <= 9)
		{
			...
			gore.velocity.Y = MathHelper.Clamp(gore.velocity.Y, 0.5f, 12f);
